...
namespace ConsoleAppContratoDeTrabalho
{
        ...
        static void Main(string[] args)
        {
            ...
            var contrato = new
            {
                Empresa = new
                {
                    ...
                    CNPJ = "93983031000190",
                    Endereco = viaCEP.GetEndereco("80230085"),
                    Numero = "123 fundos"
                },
                Funcionario = new
                {
...
EMPREGADOR: {contrato.Empresa}, com sede à (LOGRADOURO), (NUMERO), (BAIRRO), CEP (CEP), (LOCALIDADE), (UF), inscrita no CNPJ sob nº {contrato.Empresa.CNPJ};

EMPREGADO: {contrato.Funcionario}, {contrato.Funcionario.Nacionalidade}, {contrato.Funcionario.RG}, portador da cédula de identidade R.G. nº {contrato.Funcionario.RG} e CPF/MF nº {contrato.Funcionario.CPF}, residente e domiciliado na (LOGRADOURO), (NUMERO), (BAIRRO), CEP (CEP), (LOCALIDADE), (UF).

Pelo presente instrumento particular de contrato individual de trabalho, fica justo e contratado o seguinte:

Cláusula 1ª - O EMPREGADO prestará ao EMPREGADOR, a partir de {contrato.Inicio} e assinatura deste instrumento, seus trabalhos exercendo a função de (CARGO), prestando pessoalmente o labor diário no período compreendido entre 9 horas às 18 horas, e intervalo de 1 hora para almoço;

Cláusula 2ª - Não haverá expediente nos dias de sábado, sendo prestado a compensação de horário semanal;

Cláusula 3ª - O EMPREGADOR pagará mensalmente, ao EMPREGADO, a título de salário a importância de (SALÁRIO) (SALÁRIO POR EXTENSO), com os descontos previstos por lei;
